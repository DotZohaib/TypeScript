...
let g: string = "K electric ki gaand me keerha ha";
...
let newany: any;  // this is used to no  idea what is value in giving in this variable in future.
...
// type alias is a way to create a custom type name for existing data structure. 
...
// what is object in ts with code
// Ans: In TypeScript, an object is a type that 
// represents a collection of key-value pairs 
// where each key is a string (or a number) and 
// the value can be of any data type. Objects can 
...
function sum1(a:number, b: number = 2): number{
  return a*b;
}
